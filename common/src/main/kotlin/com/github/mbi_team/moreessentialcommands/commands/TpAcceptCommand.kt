            ...
            .executes { context ->
                ...
                if (target != null) {
                    ...
                    if (request != null) {
                        ...
                        sender.sendSystemMessage(Component.literal("Teleport request accepted. Teleporting to ${target.name.string}"))
                        target.sendSystemMessage(Component.literal("Accepted teleport request from ${sender.name.string}"))
